...
.VERSION
    2026-05-08-v2.4.0-PRODUCTION-IDENTITY-RECONSTRUCTION
...
$script:ToolTitle      = 'Printing Service Audit (Event ID 307)'
$script:ToolVersion    = '2026-05-08-v2.4.0-PRODUCTION-IDENTITY-RECONSTRUCTION'
...
function Get-ForensicCsvColumns {
    return @(
        ...
        'PrintDocument','PrintUser','ClientComputer','PrinterName','PrintSizeBytes','PrintPages',
...
function Invoke-ForensicAudit {
    ...
    $burstRecords = @(Add-PrintBurstIndicators -Records $timelineRecords)
