## 🖥️ ITSM-Templates-WKS Suite  
### Workstation Standardization · Windows 10/11 Compliance · ITSM Automation

![Suite](https://img.shields.io/badge/Suite-ITSM%20Templates%20WKS-0A66C2?style=for-the-badge&logo=windows&logoColor=white) ![Platform](https://img.shields.io/badge/Platform-Windows%2010%20%7C%2011-0078D6?style=for-the-badge&logo=windows&logoColor=white) ![Automation](https://img.shields.io/badge/Automation-PowerShell%20%7C%20VBScript%20%7C%20.REG-success?style=for-the-badge) ![Ops](https://img.shields.io/badge/Target-L1%20%7C%20L2%20Service%20Desk-informational?style=for-the-badge) ![Compliance](https://img.shields.io/badge/Focus-ITSM%20Compliance-critical?style=for-the-badge)

---

## 🧭 Overview

Welcome to **ITSM-Templates-WKS** — a standardized toolkit of **PowerShell, VBScript, and .REG automation files** designed for the configuration, standardization, and compliance enforcement of Windows 10 and 11 workstations across institutional environments.
...
5. **Join the Domain** — Manual or automated; authenticate using delegated account  
6. **Execute `ITSM-AfterJoinDomain.hta`** — Applies post-join fixes and logs DNS/GPO actions  
7. **Mandatory login cycles** — Perform 3× (Logon → Logoff → Reboot) under domain account  
...
2. **Post-Cleanup** → removes DNS and cached metadata  
...
Reports are exported as `.csv` files within the same structure
...
- **Reports** — CSV summaries of config states, SID, BIOS, updates, apps, and more  
...
- 🗂️ Centralize logs to a network share  
